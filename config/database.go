...
import (
	...
	//"github.com/tnqbao/gau_truyen/models"
...
//
//	err = DB.AutoMigrate(&models.Movie{}, &models.Category{}, &models.Nation{}, &models.MovieLike{}, &models.History{})
//	if err != nil {
